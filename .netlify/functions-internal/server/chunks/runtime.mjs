...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "f09bbb66-663f-422a-be54-61c95741c972",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/kyng/repos/inclusion/frontend/.data/kv"}));
...
const _0G7FPugrx5 = (function(nitro) {
...
const _E9Rqww = defineCachedEventHandler(async (event) => {
...
const _lazy_rhETpV = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_rhETpV, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _E9Rqww, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rhETpV, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, getCookie as A, deleteCookie as B, parseQuery as C, createDefu as D, createHooks as E, diff as F, withTrailingSlash as G, withoutTrailingSlash as H, toRouteMatcher as I, createRouter$1 as J, upperFirst as K, hash as L, handler as M, send as a, setResponseStatus as b, setResponseHeaders as c, useNitroApp as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$1 as h, getRouteRules as i, joinRelativeURL as j, getResponseStatusText as k, hasProtocol as l, isScriptProtocol as m, joinURL as n, klona as o, parse as p, getRequestHeader as q, defuFn as r, setResponseHeader as s, defu as t, useRuntimeConfig as u, sanitizeStatusCode as v, withQuery as w, destr as x, isEqual as y, setCookie as z };
